...
public class HashedList<T> implements Iterable<T> {
    ...
    public static void main(String[] args) {
        HashedList<String> myList = new HashedList<>();
        myList.addFirst("my first elemen");
        myList.addFirst("my new first element");
        myList.addLast("my last element");
        myList.addLast("my new last element");

        System.out.println(myList.toString());
        System.out.println(myList.size() + " == 4" );
        System.out.println(myList.contains("my first elemen" + " == true"));
        myList.remove("my new last element");
        myList.remove("my last element");
